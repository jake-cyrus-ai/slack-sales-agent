/**
 * Create Calendar Event Vercel Workflow Function
 *
 * Creates a Google Calendar event for a user asynchronously via Vercel Workflow.
...
export const createCalendarEvent = workflow.createFunction(
  {
