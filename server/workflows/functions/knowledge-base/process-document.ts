/**
 * Process Document Vercel Workflow Function
 * 
 ...
 * Accepts a base64 string (serializable across Vercel Workflow steps).
 */
...
export const processDocument = workflow.createFunction(
  { 
    id: "process-document",
    retries: 2,
  },
  ...
  async ({ event, step }) => {
    ...
    // Step 2: Download file from storage (convert to base64 for Vercel Workflow serialization)
