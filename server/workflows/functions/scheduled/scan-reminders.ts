/**
 * Reminders Scanner + Delivery — Scheduled Vercel Workflow Functions
 *
...
export const scanDueReminders = workflow.createFunction(
  {
...
export const fireReminder = workflow.createFunction(
  {
    id: "fire-reminder",
    retries: 2,
