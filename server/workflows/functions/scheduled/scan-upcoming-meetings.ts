/**
 * Scan Upcoming Meetings — Scheduled Vercel Workflow Function
 *
...
export const scanUpcomingMeetings = workflow.createFunction(
  {
  ...
  async ({ step }) => {
    ...
    // The Vercel Workflow event `id` field only deduplicates within a short window,
