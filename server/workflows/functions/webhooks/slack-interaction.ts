 ...
 *
 * Action handlers are registered in server/workflows/functions/interactions/:
...
/**
 * Main Vercel Workflow function: Handle Slack interactive components
 */
export const handleSlackInteraction = workflow.createFunction(
  {
