...
export interface UserMapping {
  /** Clerk user ID (e.g., user_2xxx) — used as FK across all tables. */
  agentUserId: string;
  /** Internal Supabase organization UUID (populated by Clerk webhook sync). */
 ...
 *
 * POST-MIGRATION: The `agentUserId` returned is the Clerk user ID directly.
 ...
 * Unlinked users are directed to sign up via the normal Clerk flow.
 */
