/**
 * Ensure Gmail Watch — Inngest Function
 *
...
export const ensureGmailWatch = inngest.createFunction(
  {
  ...
  async ({ event, step }) => {
    ...
    // (avoids stale access token if there's delay between Inngest steps)
