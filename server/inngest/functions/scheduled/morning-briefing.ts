/**
 * Morning Daily Briefing — Scheduled Inngest Functions
 *
...
export const scanMorningBriefings = inngest.createFunction(
  {
...
export const sendDailyBriefing = inngest.createFunction(
  {
