/**
 * Poll Gmail Inboxes - Scheduled Inngest Function
 * 
 * Polls Gmail for new emails as a fallback when push notifications aren't working.
 * Runs every 5 minutes via Inngest cron trigger.
 * 
...
export const pollGmailInboxes = inngest.createFunction(
  { 
 ...
 */
export const pollUserInbox = inngest.createFunction(
  { 
    id: "poll-user-inbox",
    concurrency: 5,
