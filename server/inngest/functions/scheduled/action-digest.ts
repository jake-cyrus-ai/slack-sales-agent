/**
 * Autonomous Action Digest — Scheduled Inngest Functions
 *
...
export const scanActionDigests = inngest.createFunction(
  {
...
export const sendActionDigest = inngest.createFunction(
  {
