# Admin & Onboarding Inngest Functions
...
These functions were originally HTTP endpoints in Supabase Edge Functions. They're now event-driven Inngest functions:
...
To trigger these functions, send events via Inngest:
...
2. Send test events via Inngest dashboard or programmatically
