/**
 * Google OAuth Helper for Inngest Functions
 *
 * Retrieves and refreshes Google OAuth tokens from calendar_credentials table
 * for use in Gmail and Calendar API calls within Inngest workflows.
 * 
 * Converted from Deno to Node.js for Inngest compatibility.
 */
